...
namespace OneCode.View {
    ...
    internal sealed class OneCodeWindowCommand {
        ...
        private OneCodeWindowCommand(Package package) {
            if (package == null) {
        ...
        public static void Initialize(Package package) {
            Instance = new OneCodeWindowCommand(package);
        }
        ...
        private void ShowToolWindow(object sender, EventArgs e) {
            ...
            ToolWindowPane window = this.package.FindToolWindow(typeof(OneCodeWindow), 0, true);
